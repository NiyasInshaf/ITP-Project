...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query= "SELECT username, password FROM customers WHERE username='$loginUsername' AND password='$password'"; 
	...
	<form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST">
	  <table width="100%" border="0">
	    <tbody>
	      ...
	      <tr>
	        <td align="center" class="align-content-lg-stretch"><strong>Customer Login</strong></td>
	        </tr>
	      <tr>
	        <td>Username:</td>
	        </tr>
